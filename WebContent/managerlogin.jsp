...
<div id="slideBox">
  <div class="topLayer">
    ...
    <div class="right">
    <h2 align="Center" style="color:#03A9F4">Hello Manager, Login Below</h2>
      <div class="content">
        <h2> Login</h2>
        <form method="post" name="loginform" onsubmit="return formValidation();" action="managerloginprocess.jsp">
          <div class="form-group">
